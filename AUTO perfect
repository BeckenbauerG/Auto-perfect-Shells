# Improved Auto QTE v11 (Optimized Version)

```lua
--// =====================================================
--// AUTO QTE v11 (Optimized)
--// =====================================================
--// Improvements:
--// - Better cleanup
--// - Reduced CPU usage
--// - Humanized clicking
--// - Smarter auto start
--// - Randomized click positions
--// - Safer loops
--// - Better nil protection
--// =====================================================
...
* Reduced RenderStepped spam
* FPS limiter added
* Less unnecessary loops

### Humanized Behavior

* Randomized click positions
* Randomized reaction time
* Small input variation

### Stability

* Better nil checks
* Cleaner disconnect system
* Proper destroy handler
